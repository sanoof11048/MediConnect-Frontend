                        ...
                        <div className="bg-gray-50 rounded-2xl p-6">
                            ...
                            <div className="space-y-3">
                                <div>
                                    ...
                                    <p className="font-medium text-gray-800">{patient.nurseName || "Not Assigned"}</p>
                                </div>
                                <div>
                                    ...
                                    <div key={vital.vitalId} className="mb-4 bg-red-50 border border-red-200 rounded-2xl p-4">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                                            {alerts.map((alert, index) => (
                                                <div key={index} className={`px-3 py-2 rounded-lg text-sm font-medium ${alert.color === 'red' ? 'bg-red-100 text-red-800' :
